"""Создать csv файл с данными следующей
структуры: Имя, Фамилия,
Возраст. Создать отчетный файл с
информацией по количеству людей
входящих в ту или иную возрастную группу.
Возрастные группы: 1-12, 13-18,
# 19-25, 26-40, 40+."""


import csv

category = [["1 - 12"], ["13 - 18"], ["19 - 25"], ["26 - 40"], ["40 +"]]
with open("otchet.csv") as csv_file:  # считывает и преобразует файл
    csv_reader = csv.reader(csv_file)
    for line in csv_reader:
        if int(line[-1]) <= 12:
            category[0].append(
                f"Name: {line[0]}, Surname: {line[1]}, Age: {line[2]}")
